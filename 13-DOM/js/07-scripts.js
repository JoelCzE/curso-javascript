...
console.log(heading.style);
 ...
 heading.style.backgroundColor = 'red'; //  Nota como las propiedades que le puedes pasar, son similares a las de CSS, con la 
 //diferencia de que el guion se elimina y la segunda palabra su primer letra es mayuscula.

 heading.style.textTransform = 'uppercase';
 heading.style.fontFamily = 'Arial';

 // Ahora yo no recomiendo que pongas style, ya que tu archivo JS será muy grande, otra desventaja es que la apariencia debe ser algo que
// sea responsabilidad del CSS, pero lo que si puedes hacer es agregar o quitar clases..
...
card.classList.add('nueva-clase'); // te permitirá añadir una clase.. // si deseas añadir múltiples clases debes agregar una coma en cada una
